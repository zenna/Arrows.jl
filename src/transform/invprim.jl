...
function inv(arr::CosArrow, sarr::SubArrow, abvals::IdAbVals)
  ...
  ifthenelse = add_sub_arr!(inv_cos, IfElseArrow())
  link_ports!(θ, (mod, 1))
  link_ports!((two, 1), (mod, 2))
  link_ports!((mod, 1), (equals, 1))
  link_ports!((zero, 1), (equals, 2))
  link_ports!((equals, 1), (ifthenelse, 1))
  link_ports!((one, 1), (ifthenelse, 2))
  link_ports!((negativeone, 1), (ifthenelse, 3))
  # the output of ifthenelse represents (-1)^θ = (θ % 2 == 0? 1 : -1).

  mul2 = add_sub_arr!(inv_cos, MulArrow())
  acos = add_sub_arr!(inv_cos, ACosArrow())
  link_ports!(y, (acos, 1))
  link_ports!((acos, 1), (mul2, 1))
  link_ports!((ifthenelse, 1), (mul2, 2))
...
function inv(arr::SinArrow, sarr::SubArrow, abvals::IdAbVals)
  ...
  ifthenelse = add_sub_arr!(inv_sin, IfElseArrow())
  link_ports!(θ, (mod, 1))
  link_ports!((two, 1), (mod, 2))
  link_ports!((mod, 1), (equals, 1))
  link_ports!((zero, 1), (equals, 2))
